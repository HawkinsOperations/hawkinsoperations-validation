...
HO-LAB-WAZUH-001 is a validation-owned static Wazuh rule contract lab. It gives reviewers a deterministic path to inspect the Wazuh source registry, the Wazuh logtest/static validation registry, controlled-test sample wiring, and proof-boundary metadata without requiring a live Wazuh manager.
...
- HO-DET-011 and HO-DET-012 validation entries map to Wazuh source entries and controlled-test samples.
