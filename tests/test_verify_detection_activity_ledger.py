...
class DetectionActivityLedgerTests(unittest.TestCase):
    def test_repo_ledger_matches_validation_registry_counts(self) -> None:
        ...
        self.assertEqual(result["controlled_validation_fire_count"], 64)
        self.assertEqual(result["controlled_negative_test_count"], 72)
        self.assertEqual(result["validation_case_count"], 136)
        self.assertEqual(result["detection_activity_count"], 64)
