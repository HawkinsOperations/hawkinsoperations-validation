#!/usr/bin/env python3
"""Scan scoped HO-DET-009 validation artifacts for claim-boundary violations."""
...
SCOPED_FILES = [
    ROOT / "validation" / "successor" / "ho-det-009" / "README.md",
    ROOT / "validation" / "successor" / "ho-det-009" / "validation-cases.json",
    ROOT / "reports" / "ho-det-009" / "validation-result.json",
    ROOT / "reports" / "ho-det-009" / "validation-result.md",
]
BLOCKED_TERMS = (
    'runtime-active',
    'signal-observed',
