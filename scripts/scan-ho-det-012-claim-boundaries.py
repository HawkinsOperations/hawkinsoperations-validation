#!/usr/bin/env python3
"""Scan scoped HO-DET-012 validation artifacts for claim-boundary violations."""
...
SCOPED_FILES = [
    ROOT / "validation" / "successor" / "ho-det-012" / "README.md",
    ROOT / "validation" / "successor" / "ho-det-012" / "validation-cases.json",
    ROOT / "reports" / "ho-det-012" / "validation-result.json",
    ROOT / "reports" / "ho-det-012" / "validation-result.md",
]
BLOCKED_TERMS = [
    "runtime-active",
    "signal-observed",
