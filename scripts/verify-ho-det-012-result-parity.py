#!/usr/bin/env python3
"""Verify stable HO-DET-012 validation-result parity."""
...
VALIDATOR_PATH = ROOT / "scripts" / "validate-ho-det-012.py"
VALIDATION_CASES = ROOT / "validation" / "successor" / "ho-det-012" / "validation-cases.json"
VALIDATION_RESULT = ROOT / "reports" / "ho-det-012" / "validation-result.json"
...
def load_validator():
    spec = importlib.util.spec_from_file_location("validate_ho_det_012", VALIDATOR_PATH)
    if spec is None or spec.loader is None:
        fail("could not load HO-DET-012 validator module")
