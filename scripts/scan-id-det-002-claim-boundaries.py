#!/usr/bin/env python3
"""Scan scoped ID-DET-002 validation artifacts for claim-boundary violations."""
...
SCOPED_FILES = [
    ROOT / "validation" / "identity" / "id-det-002" / "README.md",
    ROOT / "validation" / "identity" / "id-det-002" / "validation-cases.json",
    ROOT / "reports" / "id-det-002" / "validation-result.json",
    ROOT / "reports" / "id-det-002" / "validation-result.md",
]
BLOCKED_TERMS = [
    "runtime-active",
    "signal-observed",
