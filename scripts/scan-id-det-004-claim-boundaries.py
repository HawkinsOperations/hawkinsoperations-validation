#!/usr/bin/env python3
"""Scan scoped ID-DET-004 validation artifacts for claim-boundary violations."""
...
SCOPED_FILES = [
    ROOT / "validation" / "identity" / "id-det-004" / "README.md",
    ROOT / "validation" / "identity" / "id-det-004" / "validation-cases.json",
    ROOT / "reports" / "id-det-004" / "validation-result.json",
    ROOT / "reports" / "id-det-004" / "validation-result.md",
]
BLOCKED_TERMS = [
    "runtime-active",
    "signal-observed",
